...
final class GalleryImagesFilterLoadControllerTest extends AbstractWebTestCase
{
    ...
    public function testLoadGalleryImagesByFilterForInfiniteScrollingWithBadRequest(): void
    {
        $this->client->request(
            'GET',
            '/api/v1/gallery/images/filter?counter=0&filter=image',
    ...
    public function testLoadGalleryImagesByFilterForInfiniteScrollingWithInternalServerError(): void
    {
        $mediaId = 0;
