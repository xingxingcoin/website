...
final class MediaUrlCollectionByAllImagesFilterGeneratorTest extends TestCase
{
    ...
    public function testGenerate_with_png(): void
    {
        $mediaCollection = new MediaCollection([
            [
                MediaCollectionByDocumentLoader::MEDIA_FILE_EXTENSION => MediaUrlCollectionByAllImagesFilterGenerator::FILE_EXTENSION_PNG,
    ...
    public function testGenerate_with_webp(): void
    {
        $mediaCollection = new MediaCollection([
            [
                MediaCollectionByDocumentLoader::MEDIA_FILE_EXTENSION => MediaUrlCollectionByAllImagesFilterGenerator::FILE_EXTENSION_WEBP,
                MediaCollectionByDocumentLoader::IMAGE_VIEWER_URL_KEY => 'testImageViewerUrl',
                MediaCollectionByDocumentLoader::MEDIA_URL_KEY => 'testMediaUrl',
            ],
            [
