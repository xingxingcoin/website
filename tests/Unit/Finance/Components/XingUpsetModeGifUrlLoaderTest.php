...
final class XingUpsetModeGifUrlLoaderTest extends CustomTestCase
{
    ...
    private XingUpsetModeGifUrlLoader $xingUpsetModeGifUrlLoader;
    ...
    protected function setUp(): void
    {
        ...
        $this->xingUpsetModeGifUrlLoader = new XingUpsetModeGifUrlLoader(
    ...
    public function testLoadIsValid(): void
    {
        ...
        self::assertSame([
            'test' => 'test',
            'url' => 'testUrl',
            'mood' => 'A little off, not quite okay today.',
