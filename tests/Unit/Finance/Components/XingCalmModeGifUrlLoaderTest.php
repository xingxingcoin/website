...
final class XingCalmModeGifUrlLoaderTest extends CustomTestCase
{
    ...
    private XingCalmModeGifUrlLoader $xingCalmModeGifUrlLoader;
    ...
    protected function setUp(): void
    {
        ...
        $this->xingCalmModeGifUrlLoader = new XingCalmModeGifUrlLoader(
    ...
    public function testLoad_is_valid(): void
    {
        ...
        $newFinanceDataCollection = $this->xingCalmModeGifUrlLoader->load($financeDataCollection, $expectedLocation);
