...
final class XingRageModeGifUrlLoaderTest extends CustomTestCase
{
    ...
    private XingRageModeGifUrlLoader $xingRageModeGifUrlLoader;
    ...
    protected function setUp(): void
    {
        ...
        $this->xingRageModeGifUrlLoader = new XingRageModeGifUrlLoader(
    ...
    public function testLoad_is_valid(): void
    {
        ...
        $newFinanceDataCollection = $this->xingRageModeGifUrlLoader->load($financeDataCollection, $expectedLocation);
        ...
        self::assertEquals([
            'info' => [
                [
                    'message' => 'Start loading xing rage mode gif url.',
                    'context' => [],
                ],
                [
                    'message' => 'Xing rage mode gif url is loaded successfully.',
                    'context' => [
                        'mediaId' => 1,
                        'url' => 'testUrl'
                    ],
    ...
    public function testLoad_with_MediaNotFoundException(): void
    {
        ...
        try {
            $this->xingRageModeGifUrlLoader->load(
        ...
        self::assertEquals([
            ...
            'notice' => [
                [
                    'message' => 'Xing rage mode gif url is not loaded.',
                    'context' => [],
                ]
            ],
            'debug' => [
