...
export default class CookieConsentHandler {
    ...
    constructor(
        cookieConsentPreferenceSelector: string,
        cookieFooterPreferenceShowButtonSelector: string,
    ) {
        this.cookiePreferenceShowButton = document.querySelector(cookieConsentPreferenceSelector);
        this.cookieFooterPreferenceShowButton = document.querySelector(
            cookieFooterPreferenceShowButtonSelector,
        );
    ...
    private initEventListener(): void {
        document.addEventListener('DOMContentLoaded', (): void => {
            ...
            (this.cookieFooterPreferenceShowButton as Element).addEventListener(
                'click',
                (): void => {
