export default class NavigationAudioPlayer {
    ...
    private initEventListener(): void {
        (this.navigationAudioPlayerButton as HTMLButtonElement).addEventListener('click', function (event: MouseEvent): void {
            event.preventDefault();
            let audioPlayButton: HTMLButtonElement = this;
            const audioPlayer = document.getElementById('navigation-audio-player') as HTMLAudioElement | null;
            if (audioPlayer === null) {
                return;
            }
