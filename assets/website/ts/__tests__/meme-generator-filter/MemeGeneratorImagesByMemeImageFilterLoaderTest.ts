...
describe('Meme generator images by meme image filter are loaded', (): void => {
    ...
    test('Meme generator images by meme image filter are loaded successful', (): void => {
        ...
        let memeGeneratorImagesByMemeImageFilterLoader: MemeGeneratorImagesByMemeImageFilterLoader = new MemeGeneratorImagesByMemeImageFilterLoader(
        ...
        expect(xhrMock.open).toHaveBeenCalledWith(MemeGeneratorImagesByMemeImageFilterLoader.METHOD, MemeGeneratorImagesByMemeImageFilterLoader.URL + 0, true);
        ...
        expect(Array.from(expectedMemeImageFilterButton.classList)).toEqual(['xing-media-filter-button-selected']);
    ...
    test('loadingIndicator is not found', (): void => {
        ...
        try {
            ...
            expect(error.message).toBe('Meme generator images by meme image filter are not loaded.');
        }

        expect(xhrMock.open).not.toHaveBeenCalledWith(MemeGeneratorImagesByMemeImageFilterLoader.METHOD, MemeGeneratorImagesByMemeImageFilterLoader.URL + 0, true);
