...
describe('Gallery images by image filter are loaded', (): void => {
    ...
    test('Gallery images by image filter are loaded successful', (): void => {
        ...
        let galleryImagesByImageFilterLoader: GalleryImagesByImageFilterLoader = new GalleryImagesByImageFilterLoader(
        ...
        expect(xhrMock.open).toHaveBeenCalledWith(GalleryImagesByImageFilterLoader.METHOD, GalleryImagesByImageFilterLoader.URL + 0, true);
        ...
        expect(Array.from(expectedImageFilterButton.classList)).toEqual(['xing-media-filter-button-selected']);
    });
    ...
    test('loadingIndicator is not found', (): void => {
        ...
        expect(xhrMock.open).not.toHaveBeenCalledWith(GalleryImagesByImageFilterLoader.METHOD, GalleryImagesByImageFilterLoader.URL + 0, true);
