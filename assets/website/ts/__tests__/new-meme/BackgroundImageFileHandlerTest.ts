...
describe('read background image file', (): void => {
    ...
    beforeEach((): void => {
        ...
        backgroundImageInput = document.getElementById('background-image-selector') as HTMLInputElement;
        label = document.querySelector('label[for="background-image-selector"]') as HTMLLabelElement;
    });
