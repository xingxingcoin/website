...
describe('meme generator images added', (): void => {
    ...
    test('meme generator images added successfully', (): void => {
        let memeGeneratorImagesManipulator: MemeGeneratorImagesManipulator = new MemeGeneratorImagesManipulator('.xing-media-container');
        ...
        let expectedXingMediaContainer: HTMLDivElement = document.querySelector('.xing-media-container') as HTMLDivElement;
        expect(expectedXingMediaContainer.innerHTML.replace(/\s+/g, '')).toBe('<aclass="container-left-hidden"href="test"><divclass="xing-image-container"><imgsrc="test"alt="ImageofXing"></div></a><aclass="container-left-hidden"href="test2"><divclass="xing-image-container"><imgsrc="test2"alt="ImageofXing"></div></a>');
    });
