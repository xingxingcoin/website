...
import MemeGeneratorInfiniteScrollingImageLoader
    from '../../src/meme-generator-infinite-scrolling/MemeGeneratorInfiniteScrollingImageLoader';
...
describe('meme generator infinite scrolling images are loaded', (): void => {
    ...
    test('meme generator infinite scrolling images are loaded successfully', (): void => {
        ...
        const memeGeneratorInfiniteScrollingImageLoader = new MemeGeneratorInfiniteScrollingImageLoader(
        ...
        expect(xhrMock.open).toHaveBeenCalledWith(MemeGeneratorInfiniteScrollingImageLoader.METHOD, MemeGeneratorInfiniteScrollingImageLoader.URL + 1, true);
    ...
    test('url length equals to 0', (): void => {
        ...
        expect(xhrMock.open).toHaveBeenCalledWith(MemeGeneratorInfiniteScrollingImageLoader.METHOD, MemeGeneratorInfiniteScrollingImageLoader.URL + 1, true);
        expect(xhrMock.send).toHaveBeenCalled();
        expect(memeGeneratorImagesManipulatorMock.displayImagesInMemeGenerator).toHaveBeenCalledWith([]);
        expect(containerAnimationInitializerMock.init).toHaveBeenCalled();
    ...
    test('footerPosition bigger than windowHeight + 50', (): void => {
        ...
        expect(xhrMock.open).not.toHaveBeenCalledWith(MemeGeneratorInfiniteScrollingImageLoader.METHOD, MemeGeneratorInfiniteScrollingImageLoader.URL + 1, true);
